...
class InvoiceEndpointTest {
    ...
    void init() {
        ...
        company1 = new Company(3L, "ABC", "aaa", "1111", "123123", "00-00", "email@ABC.com");
        company2 = new Company(4L, "XYZ", "bbb", "2222", "321321", "11-10", "email@XYZ.com");
        ...
        invoice1 = new Invoice(0L, "1/2019", LocalDate.of(2019, 3, 1), LocalDate.of(2019, 3, 20), company1, company2, entryList);
        invoice2 = new Invoice(0L, "2/2019", LocalDate.of(2018, 1, 1), LocalDate.of(2018, 6, 20), company2, company1, entryList);
    }
    ...
    void shouldValidateXsdGetAllInvoicesByDateResponse() throws IOException, ServiceOperationException {
        ...
        File filePathRequest = new File("src/test/resources/getInvoicesByDateRequest");
        File filePathResponse = new File("src/test/resources/getInvoicesByDateResponse");
        String getInvoiceStringRequest = XmlFileReader.readFromFile(filePathRequest);
        String getInvoiceStringResponse = XmlFileReader.readFromFile(filePathResponse);
        Source requestPayload = new StringSource(getInvoiceStringRequest);
        Source responsePayload = new StringSource(getInvoiceStringResponse);
    ...
    void shouldValidateXsdGetAllInvoicesBySellerResponse() throws IOException, ServiceOperationException {
        ...
        File filePathRequest = new File("src/test/resources/getInvoicesBySellerRequest");
        File filePathResponse = new File("src/test/resources/getInvoicesBySellerResponse");
        String getInvoiceStringRequest = XmlFileReader.readFromFile(filePathRequest);
        String getInvoiceStringResponse = XmlFileReader.readFromFile(filePathResponse);
        Source requestPayload = new StringSource(getInvoiceStringRequest);
        Source responsePayload = new StringSource(getInvoiceStringResponse);
